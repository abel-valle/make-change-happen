              ...
              <form onSubmit={submitEnrollData}>
                <div className="grid bg-yellow-100 gap-4 px-8 mb-2 sm:gap-6 sm:mb-6 sm:grid-cols-4 rounded-lg">
                  ...
                  <div className="mt-2 sm:mt-8 sm:mb-8 sm:col-start-2 sm:col-span-2">
                    <input
                      type="text"
                      className="mt-8 mb-2 text-sm sm:text-md peer block min-h-fit w-full rounded border-0 px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-100"
