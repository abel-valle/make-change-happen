        ...
        <ScrollAnimationWrapper>
          ...
          >
            <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
              <h2 className="text-teal-500">¿Qué es Make Change Happen?</h2>
              ...
              <p className="text-justify text-black-500 mt-2 mb-6">
                ...
                con día, las personas pueden encontrar la motivación para tomar
                la decisión y acción de{" "}
                <span className="text-teal-500">RE-INVENTARSE</span> y{" "}
                <span className="text-teal-500">RE-DISEÑAR</span> la trayectoria
                de su vida personal y profesional de manera consciente.
              </p>
              ...
              <p className="text-justify text-black-500 mt-2 mb-2">
                ...
                está basado en el pensamiento de que cada persona es responsable
                de tomar la decisión y acción para diseñar una visión clara de
                lo que quiere lograr en su vida.{" "}
                <span className="text-teal-500">
                  Un framekwork será la guía que te acompañará paso a paso a
                  través de 5 niveles
                </span>{" "}
                para lograr los cambios, avances y resultados de una manera más
                divertida y ágil.
              </p>
              <p className="text-justify text-black-500 mt-2 mb-2">
